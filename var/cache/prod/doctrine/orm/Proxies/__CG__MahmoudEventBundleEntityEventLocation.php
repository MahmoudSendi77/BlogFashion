 ...
 */
class EventLocation extends \Mahmoud\EventBundle\Entity\EventLocation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mahmoud\\EventBundle\\Entity\\EventLocation' . "\0" . 'id', '' . "\0" . 'Mahmoud\\EventBundle\\Entity\\EventLocation' . "\0" . 'eventId', '' . "\0" . 'Mahmoud\\EventBundle\\Entity\\EventLocation' . "\0" . 'lattitude', '' . "\0" . 'Mahmoud\\EventBundle\\Entity\\EventLocation' . "\0" . 'longitude'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventLocation $proxy) {
