...
class appProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/event')) {
            // mahmoud_event_homepage
            if ('/event' === $trimmedPathinfo) {
                $ret = array (  '_controller' => 'Mahmoud\\EventBundle\\Controller\\DefaultController::indexAction',  '_route' => 'mahmoud_event_homepage',);
                if ('/' === substr($pathinfo, -1)) {
                    // no-op
                } elseif ('GET' !== $canonicalMethod) {
                    goto not_mahmoud_event_homepage;
                } else {
                    return array_replace($ret, $this->redirect($rawPathinfo.'/', 'mahmoud_event_homepage'));
                }

                return $ret;
            }
            not_mahmoud_event_homepage:
