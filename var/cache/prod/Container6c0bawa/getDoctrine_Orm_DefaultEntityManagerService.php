...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Mahmoud\\EventBundle\\Entity')]);
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'MahmoudEventBundle' => 'Mahmoud\\EventBundle\\Entity']);
