...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'security.request_matcher.em5y_bu' => 'getSecurity_RequestMatcher_Em5yBuService.php',
        ...
        $this->privates = [
            ...
            'security.request_matcher.em5y_bu' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('6xWmtcDXHt', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('w8QG0OJh7q', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'chickclick', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => [], 'defaultTableOptions' => []], $a, $c, []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Mahmoud\\EventBundle\\Entity'), 2 => ($this->targetDirs[3].'\\vendor\\mgilet\\notification-bundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\EspritApiBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\TicketBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\ProductBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\PublicationBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\ForumBundle\\Entity'), 8 => ($this->targetDirs[3].'\\src\\AskBundle\\Entity'), 9 => ($this->targetDirs[3].'\\src\\FollowBundle\\Entity')]);

        $b->addDriver($c, 'AppBundle\\Entity');
        $b->addDriver($c, 'Mahmoud\\EventBundle\\Entity');
        $b->addDriver($c, 'Mgilet\\NotificationBundle\\Entity');
        $b->addDriver($c, 'EspritApiBundle\\Entity');
        $b->addDriver($c, 'TicketBundle\\Entity');
        $b->addDriver($c, 'ProductBundle\\Entity');
        $b->addDriver($c, 'PublicationBundle\\Entity');
        $b->addDriver($c, 'ForumBundle\\Entity');
        $b->addDriver($c, 'AskBundle\\Entity');
        $b->addDriver($c, 'FollowBundle\\Entity');
        ...
        $a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'MahmoudEventBundle' => 'Mahmoud\\EventBundle\\Entity', 'MgiletNotificationBundle' => 'Mgilet\\NotificationBundle\\Entity', 'EspritApiBundle' => 'EspritApiBundle\\Entity', 'TicketBundle' => 'TicketBundle\\Entity', 'ProductBundle' => 'ProductBundle\\Entity', 'PublicationBundle' => 'PublicationBundle\\Entity', 'ForumBundle' => 'ForumBundle\\Entity', 'AskBundle' => 'AskBundle\\Entity', 'FollowBundle' => 'FollowBundle\\Entity']);
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_a01982a413b153a89f443d01abb3c71e716559c9c40a55f8a6e9f4ee8e49bf74');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4zd9e8WPMz', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Y5f+r6GPNB', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pmRNJszM2L', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.main' => function () {
            ...
            yield 'security.firewall.map.context.main' => ${($_ = isset($this->services['security.request_matcher.em5y_bu']) ? $this->services['security.request_matcher.em5y_bu'] : ($this->services['security.request_matcher.em5y_bu'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^'))) && false ?: '_'};
        }, 1));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'\\src\\Mahmoud\\EventBundle/Resources/views'), 'MahmoudEvent');
        $instance->addPath(($this->targetDirs[3].'\\src\\Mahmoud\\EventBundle/Resources/views'), '!MahmoudEvent');
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\mgilet\\notification-bundle/Resources/views'), '!MgiletNotification');
        $instance->addPath(($this->targetDirs[3].'\\src\\EspritApiBundle/Resources/views'), 'EspritApi');
        $instance->addPath(($this->targetDirs[3].'\\src\\EspritApiBundle/Resources/views'), '!EspritApi');
        $instance->addPath(($this->targetDirs[3].'\\src\\TicketBundle/Resources/views'), 'Ticket');
        $instance->addPath(($this->targetDirs[3].'\\src\\TicketBundle/Resources/views'), '!Ticket');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ForumBundle/Resources/views'), '!Forum');
        $instance->addPath(($this->targetDirs[3].'\\src\\AskBundle/Resources/views'), 'Ask');
        $instance->addPath(($this->targetDirs[3].'\\src\\AskBundle/Resources/views'), '!Ask');
        $instance->addPath(($this->targetDirs[3].'\\src\\FollowBundle/Resources/views'), 'Follow');
        $instance->addPath(($this->targetDirs[3].'\\src\\FollowBundle/Resources/views'), '!Follow');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'MahmoudEventBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Mahmoud\\EventBundle'),
                    'namespace' => 'Mahmoud\\EventBundle',
                ],
                'FOSUserBundle' => [
                    'parent' => NULL,
                ...
                'EspritApiBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\EspritApiBundle'),
                    'namespace' => 'EspritApiBundle',
                ],
                'TicketBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\TicketBundle'),
                    'namespace' => 'TicketBundle',
                ],
                'ProductBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ProductBundle'),
                ...
                'AskBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AskBundle'),
                    'namespace' => 'AskBundle',
                ],
                'FollowBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\FollowBundle'),
                    'namespace' => 'FollowBundle',
                ],
                'DebugBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'MahmoudEventBundle' => 'Mahmoud\\EventBundle\\MahmoudEventBundle',
                ...
                'EspritApiBundle' => 'EspritApiBundle\\EspritApiBundle',
                'TicketBundle' => 'TicketBundle\\TicketBundle',
                ...
                'AskBundle' => 'AskBundle\\AskBundle',
                'FollowBundle' => 'FollowBundle\\FollowBundle',
