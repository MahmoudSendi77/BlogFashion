...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Mahmoud\\EventBundle\\Entity'), 2 => ($this->targetDirs[3].'\\vendor\\mgilet\\notification-bundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\EspritApiBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\TicketBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\ProductBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\PublicationBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\ForumBundle\\Entity'), 8 => ($this->targetDirs[3].'\\src\\AskBundle\\Entity')]);
